    ...
    Box(
        ...
        Row(
            ...
            IconButton(onClick = { /* Handle undo */ }) {
                Icon(
                    painterResource(id = R.drawable.undo_24px), contentDescription = "Undo", modifier = Modifier
                    .background(
            ...
            IconButton(onClick = { /* Handle redo */ }) {
                Icon(
                    painterResource(id = R.drawable.redo_24px), contentDescription = "Redo", modifier = Modifier
                    .background(
                        color = Color.LightGray,
                        shape = CircleShape,
                    )
            ...
            IconButton(onClick = {
                ...
                Icon(
                    painterResource(id = R.drawable.delete_24px), contentDescription = "Delete", modifier = Modifier
                    .background(
                        color = Color.LightGray,
                        shape = CircleShape,
                    )
            ...
            IconButton(onClick = { /* Handle redo */ }) {
                Icon(
                    painterResource(id = R.drawable.settings_24px), contentDescription = "Settings", modifier = Modifier
                    .background(
                        color = Color.LightGray,
                        shape = CircleShape,
                    )
